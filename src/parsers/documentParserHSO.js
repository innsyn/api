 ...
 * HSO
 *
 * duplicate of Bystyret via SSHF - match for first 9 values, but different logic for classification
 * reworked along style of UniBlue and Forsvaret - direct split and scan
 */
module.exports = {
  /***
